            ...
            <div class="p-4">
              <form  method="post" data-parsley-validate="" novalidate="">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="color" parsley-trigger="change" alt="image" required="" placeholder="Enter Image" value="${product.getColor()}" class="form-control" id="color">
                </div>

                <div class="form-group">
                  <label for="des">Color<span class="text-danger">*</span></label>
                  <input type="text" name="des" parsley-trigger="change" alt="image" required="" placeholder="Enter Image" value="${product.getDes()}" class="form-control" id="des">
                </div>
